    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>().HasData(
            new List<Product>
            {
                ...
                IsActive = true, ImageUrl = "https://example.com/product1.jpg", Stock = 100 },
                new Product { Id = 2, Name = "Product 2", Description = "Description for Product 2", Price = 20.99m,
                IsActive = true, ImageUrl = "https://example.com/product2.jpg", Stock = 50 },
                new Product { Id = 3, Name = "Product 3", Description = "Description for Product 3", Price = 30.99m,
                IsActive = true, ImageUrl = "https://example.com/product3.jpg", Stock = 25 },
                new Product { Id = 4, Name = "Product 4", Description = "Description for Product 4", Price = 40.99m,
                IsActive = true, ImageUrl = "https://example.com/product4.jpg", Stock = 75 }               
            }
        );
    }
}